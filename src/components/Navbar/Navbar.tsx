    ...
    <div className="shadow-md bg-white dark:bg-gray-900 dark:text-white duration-200 py-">
      <div className="container py-1 sm:py-0">
        <div className="flex justify-between items-center">
          {/* Logo */}
          <Link to="/" className="font-bold text-1xl sm:text-4xl flex gap-0 items-center bg-clip-text text-transparent bg-gradient-to-r from-green-600 to-verde">
          ...
          <div className="flex items-center gap-4 ml-auto">
            ...
            <Link to="/login">
              <img
                ...
                className="w-10 h-10 rounded-full mb-4 p-1 m-5 object-cover transition-transform duration-300 ease-in-out group-hover:scale-110 bg-red-300"
                alt="Usuário"
              />
            </Link>

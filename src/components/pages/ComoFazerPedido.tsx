      ...
      <section className="text-center py-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 px-6 md:px-20">
          <div className="flex flex-col items-center">
            <img src="https://i.ibb.co/tMCjn8R6/Fast-Chef-3.png" alt="Pesquisar pela refeição" className="w-50 h-50" />
            <span className="text-xl font-bold mt-2">01</span>
            <p>Pesquisar pela refeição</p>
          </div>
          <div className="flex flex-col items-center">
            <img src="https://i.ibb.co/HDM4jTTm/Fast-Chef-4.png" alt="Adicionar ao carrinho" className="w-50 h-50" />
